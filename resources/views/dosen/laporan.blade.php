...
<div class="flex justify-between items-end mb-8">
    ...
    <a href="/dosen/laporan/ekspor?{{ http_build_query(request()->all()) }}" class="bg-[#004133] text-white px-5 py-2.5 rounded-xl font-semibold text-sm hover:bg-[#003328] transition-colors shadow-sm flex items-center gap-2">
...
<div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-6 mb-8">
    <form action="/dosen/laporan" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
        <div>
        ...
        <div class="flex gap-2">
            ...
            <a href="/dosen/laporan" class="px-4 py-2.5 border border-gray-200 text-gray-600 rounded-xl text-sm font-semibold hover:bg-gray-50 flex items-center justify-center">
                Reset
            </a>
        </div>
    </form>
